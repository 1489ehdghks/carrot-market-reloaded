...
// 설정용 Select 컴포넌트 통합
interface CustomSettingSelectProps {
  title: string
  description?: string
  defaultValue: string
...
export function CustomSettingSelect({
  title,
  description,
  defaultValue,
  onValueChange,
  ...
  return (
    <div className={className}>
      ...
      <CustomSelect defaultValue={defaultValue} onValueChange={onValueChange}>
