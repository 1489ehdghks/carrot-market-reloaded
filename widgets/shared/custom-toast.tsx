...
type CustomToastProps = React.ComponentPropsWithoutRef<typeof CustomToast>

type CustomToastActionElement = React.ReactElement<typeof CustomToastAction>

export {
  type CustomToastProps,
  type CustomToastActionElement,
  CustomToastProvider,
  CustomToastViewport,
  CustomToast,
  CustomToastTitle,
...
type ToastState = {
  ...
  action?: CustomToastActionElement
  open: boolean
