...
import { SparklesIcon, ClockIcon, ChevronRightIcon, ClipboardIcon, ChevronDoubleDownIcon, FireIcon, ChatBubbleBottomCenterTextIcon } from "@heroicons/react/24/outline"
...
export default function RightSidebar() {
  ...
  return (
    <aside className="hidden lg:flex flex-col w-80 fixed right-0 top-0 h-full bg-neutral-900/95 backdrop-blur-sm z-50 border-l border-neutral-800/50 overflow-y-auto">
